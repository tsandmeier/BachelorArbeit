...
public class AutomatedSectionification {
...
//        SystemScope.Builder.getScopeHandler().addScopeSpecification(DataStructureLoader.loadSlotFillingDataStructureReader("Injury")).build();
        ...
        for (Instance instance : instanceProvider.getInstances()) {
            ...
            AutomatedSectionification sectionify = new AutomatedSectionification(instance);
...
//    public static EInjuryModifications rule;
    ...
    public AutomatedSectionification(Instance instance) {
...
//	188, 184 193 N243
    ...
    private final static Map<Instance, AutomatedSectionification> factory = new ConcurrentHashMap<>();

    public static AutomatedSectionification getInstance(Instance instance) {
        AutomatedSectionification sec;
        if ((sec = factory.get(instance)) == null)
            synchronized (factory) {
                factory.put(instance, sec = new AutomatedSectionification(instance));
            }
