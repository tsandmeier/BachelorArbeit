...
public class NERLASpecsInjury {
	 ...
	 */
	private final static File entities = new File("src/main/resources/examples/nerla/injury/specs/csv/entities_full.csv");
	 ...
	 **/
	private final static File slots = new File("src/main/resources/examples/nerla/injury/specs/csv/slots.csv");
	 ...
	 **/
	private final static File structures = new File("src/main/resources/examples/nerla/injury/specs/csv/structures.csv");
