...
public class NERLASpecs {
	 ...
	 */
	private final static File entities = new File("src/diesdas/resources/examples/nerla/specs/csv/entities.csv");
	 ...
	 **/
	private final static File slots = new File("src/diesdas/resources/examples/nerla/specs/csv/slots.csv");
	 ...
	 **/
	private final static File structures = new File("src/diesdas/resources/examples/nerla/specs/csv/structures.csv");

	/**
	 * Specification file of entity hierarchies. This is not necessary for NERLA but
	 * might be helpful for feature generation.
	 */
	private final static File hierarchies = new File("src/diesdas/resources/examples/nerla/specs/csv/hierarchies.csv");
