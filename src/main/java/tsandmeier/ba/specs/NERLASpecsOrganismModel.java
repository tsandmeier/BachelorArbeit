...
public class NERLASpecsOrganismModel {
	 ...
	 */
	private final static File entities = new File("src/main/resources/examples/nerla/organismModel/specs/csv/entities.csv");
	 ...
	 **/
	private final static File slots = new File("src/main/resources/examples/nerla/organismModel/specs/csv/slots.csv");
	 ...
	 **/
	private final static File structures = new File("src/main/resources/examples/nerla/organismModel/specs/csv/structures.csv");

	/**
	 * Specification file of entity hierarchies. This is not necessary for NERLA but
	 * might be helpful for feature generation.
	 */
	private final static File hierarchies = new File("src/main/resources/examples/nerla/organismModel/specs/csv/hierarchies.csv");

	public static final ISpecificationsReader csvSpecsReader = new CSVDataStructureReader(NERLASpecsOrganismModel.entities,
			NERLASpecsOrganismModel.hierarchies, NERLASpecsOrganismModel.slots, NERLASpecsOrganismModel.structures);
}
