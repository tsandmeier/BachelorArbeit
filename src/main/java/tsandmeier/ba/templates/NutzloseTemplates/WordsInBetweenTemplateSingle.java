 ...
 */
public class WordsInBetweenTemplateSingle extends AbstractFeatureTemplate<WordsInBetweenTemplateSingle.WordsInBetweenScope> {
    ...
    public void generateFeatureVector(Factor<WordsInBetweenScope> factor) {
        ...
        if (indexTokenTwo - indexTokenOne < MAX_NUMBER_OF_WORDS && !(indexTokenTwo - indexTokenOne == 1)) {
